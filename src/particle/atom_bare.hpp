...
#ifndef BARE_ATOM_HPP
#define BARE_ATOM_HPP
...
/*
 * This class will be recoded
 * TO BE A BARE ATOM CLASS
 *   a BARE atom means it is an atom, not spatially related to any structure, 
 *   structural independent, contains self, inner properties, like, electrons, orbitals, mass, radioativities, 
 *   neurons, protons, quarks, quantum numbers
 *   instead of position information
 * Similarly, a BARE molecule will also be coded, which is position independent, using
 * internal coordinates instead of cartesian coordinates to label the atoms in it
 */
